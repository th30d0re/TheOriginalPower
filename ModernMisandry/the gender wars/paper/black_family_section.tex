...
For the full formal framework mapping these empirical findings onto the five-tier extraction architecture ($E$, $P_{\text{uppet}}$, $F_{\text{enforce}}$, $I_{\text{buffer}}$, $O_{\text{racialized}}$), see Chapter~8 of \textit{The Mathematics of Oppression} (``The Terminal Output: Black Family Dissolution as Five-Tier Execution'').
