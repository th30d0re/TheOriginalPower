...
\begin{figure}[htbp]
\centering
\textbf{Figure 11: HOLC Redlining and Violent Crime Density Overlays --- Six U.S. Cities}\\[0.5em]

\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{../../Paper/figures/spatial/cs9_overlay_baltimore_md.png}
\\[0.2em]
\small\textbf{(a)} Baltimore, MD
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{../../Paper/figures/spatial/cs9_overlay_nashville_tn.png}
\\[0.2em]
\small\textbf{(b)} Nashville, TN
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{../../Paper/figures/spatial/cs9_overlay_detroit_mi.png}
\\[0.2em]
\small\textbf{(c)} Detroit, MI
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{../../Paper/figures/spatial/cs9_overlay_washington_dc.png}
\\[0.2em]
\small\textbf{(d)} Washington, DC
\end{minipage}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{../../Paper/figures/spatial/cs9_overlay_memphis_tn.png}
\\[0.2em]
\small\textbf{(e)} Memphis, TN
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{../../Paper/figures/spatial/cs9_overlay_milwaukee_wi.png}
\\[0.2em]
\small\textbf{(f)} Milwaukee, WI
\end{minipage}

\vspace{0.5em}
\parbox{\linewidth}{\raggedright\small\emph{HOLC residential security grades (red = Grade D ``Hazardous'') overlaid with late-20th-century violent crime density clusters in six major U.S. cities. In each metropolitan area, the spatial coincidence between historically redlined zones and elevated violence density demonstrates the enduring pipeline from state-mandated disinvestment to concentrated lethal harm. Interstate highways (visible as linear corridors in several panels) were routed through these same redlined corridors, concentrating neurotoxic lead exhaust onto populations already trapped by capital starvation. Sources: University of Richmond Digital Scholarship Lab, \emph{Mapping Inequality}; city-level police department incident data.}}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{../../Paper/figures/spatial/cs9_pooled_stats.png}
\caption*{\textbf{Figure 12: Pooled Spatial Statistics --- Redlining and Violent Crime Correlation Across Six Metropolitan Areas}\\[0.3cm]
\emph{Pooled statistical summary quantifying the spatial association between HOLC redlining grades and violent crime incidence across Baltimore, Detroit, Memphis, Milwaukee, Nashville, and Washington, DC. The analysis confirms that Grade D (red/Hazardous) zones consistently register significantly elevated violence rates relative to Grade A (green/Best) zones, controlling for contemporary socioeconomic variables. Sources: University of Richmond Digital Scholarship Lab, \emph{Mapping Inequality}; FBI Uniform Crime Reports; BJS.}}
\end{figure}
...
\caption*{\textbf{Figure 13: The Impossibility of Proving Discriminatory Intent Under \emph{Arlington Heights}}\\[0.3cm]
