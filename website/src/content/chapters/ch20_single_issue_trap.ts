  ...
  scenes: [
    {
      ...
      prose: [
        'Multi-axis noise cancellation describes a coalition-defense mechanism. A movement aligns around one primary issue. Polarizing identity signals then load secondary axes, increase repulsion among potential allies, and neutralize the movement’s kinetic force.',
        'The mechanism works through existing ideological terrain. MAGA and BLM identification carry genuine preference distances with historical roots. The extraction operator selectively amplifies those distances during coalition formation, when their salience imposes the highest cost on a possible alliance.',
        'The Boston case places this process at human scale: a rally, a microphone, a plastic training rifle, a police call, and a coalition that fails to consolidate. A secondary identity prior makes potential allies unreadable to one another and routes fear into enforcement.',
...

    {
      ...
      prose: [
        ...
        'The speaker identified the operational sequence. A secondary axis attaches to the primary issue. Existing distances gain immediate salience. The coalition fractures during formation, before it can pool force across racial and partisan lines.',
      ],
      keyConcepts: [
        {
...

    {
      ...
      prose: [
        'The speaker’s microphone was cut while he advocated for a unified coalition across racial and partisan lines. The interruption silenced the rally’s direct structural critique at the moment of delivery. The movement preserved the identity framework that kept its constituency isolated.',
...

    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'prose',
          paragraphs: [
            'The caller processed a Black man near a blue plastic training tool through a racialized threat prior. That perception activated the enforcement apparatus against the Out-group. The Bayesian Defense and the Racialization Differential describe this conversion of an observed object into a lethal-threat judgment.',
            'The police response brought actual loaded firearms into a peaceful discussion. The call created the volatile environment the caller feared. Internalized racial priors, a report, and armed enforcement completed the causal chain.',
          ],
        },
      ],
      keyConcepts: [
