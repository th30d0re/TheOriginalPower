...
- **Anchor:** `Emmanuel Theodore (02:41)`
- **Hold:** through 03:04
...
- **Anchor:** `Emmanuel Theodore (04:00)`
- **Hold:** through 04:25
...
- **Anchor:** `Emmanuel Theodore (03:31)`
...
- **Anchor:** `Emmanuel Theodore (04:33)`
- **Hold:** through 05:07
...
- **Anchor:** `Emmanuel Theodore (07:55)`
- **Hold:** through 08:34
...
- **Anchor:** `Emmanuel Theodore (07:36)`
- **Hold:** through 07:57
...
- **Anchor:** `Emmanuel Theodore (08:15)`
- **Hold:** through 08:49
...
- **Anchor:** `Emmanuel Theodore (08:52)`
- **Hold:** through 09:56
...
- **Anchor:** `Emmanuel Theodore (09:58)`
- **Hold:** through 10:44
...
- **Anchor:** `Emmanuel Theodore (11:27)`
- **Hold:** through 15:00
...
- **Anchor:** `Emmanuel Theodore (15:22)`
- **Hold:** through 16:10
...
- **Anchor:** `Emmanuel Theodore (16:20)`
- **Hold:** through 16:47
...
- **Anchor:** `Emmanuel Theodore (16:55)`
- **Hold:** through 17:44
...
- **Note:** `[book]` `"derive the mechanism that produces all three"`. This is the spine of the
...
- **Anchor:** `Emmanuel Theodore (22:12)`
- **Hold:** through 17:58
...
- **Note:** `[book]` `"From Bias to Bytes: A Machine Learning"`. Spell "Bytes" correctly. Every
...
- **Note:** `[book]` `"Critical Race Theory, cognitive bias research"`. Dim the two on the left at 12:01 when narration moves to
...
- **Note:** `[book]` `"The mathematics it promised was absent from"`, verbatim. Let it sit in
  silence against the `[beat]` in the script.

## G-19 — Lost document, found

- **Anchor:** `Emmanuel Theodore (32:00)`
- **Hold:** through 32:52
...
- **Note:** `[data]` + `[book]` `"Black, 7.00; Native American, 6.55"` and `:4953`. Cite the
...
- **Note:** `[book]` `"little group-identifying signal"`. Do not dramatize the right panel. The honesty is the point.

## G-22 — The casino

- **Anchor:** `Toussaint (27:37)`
- **Hold:** through 23:52
...
- **Note:** `[book]` `"incident-only data can"`.

## G-24 — The mirror

- **Anchor:** `Toussaint (29:30)`
- **Type:** simple flow
...
- **Note:** `[book]` `"explicit and inferred racial markers"`. Draw a 50% parity reference
...
- **Note:** `[book]` `"the Agenda-Setter Trap"`, Tweedism chapter.
...
- **Note:** `[book]` `"Black Reconstruction in America* (1935"`, `:845-848`, `:894-895`, and
...
- **Anchor:** `Emmanuel Theodore (43:48)`
- **Hold:** through 44:44
...
- **Anchor:** `Emmanuel Theodore (44:58)`
- **Hold:** through 47:02
...
- **Anchor:** `Emmanuel Theodore (58:12)`
- **Hold:** through 58:41
- **Type:** end card
...
- **Note:** `[book]` `"the fractal mind virus. The"` onward.
